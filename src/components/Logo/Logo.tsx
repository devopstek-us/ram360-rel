    ...
    <>
      ...
      >
        <g
          ...
          id="b5e2fd40-bb33-450d-b598-6c92bd360a50"
        >
          <rect
            style={{
              stroke: "none",
        ...
        <g
          ...
          id="1776d6f7-ce12-4555-99f3-d598152f8607"
        ></g>
        <g
          transform="matrix(1.77 0 0 1.82 461.07 269.42)"
          id="de8422f2-560e-4371-949d-bf395b28e72d"
        >
          <text
            font-family="Raleway"
            font-size="105"
          ...
          >
            <tspan x="-115.29" y="32.98">
              RAM
            </tspan>
          </text>
        </g>
        <g
          transform="matrix(1.77 0 0 1.82 836.84 271.13)"
          id="50deda52-afd7-49ae-9e27-ed787f63c767"
        >
          <text
        ...
        <g transform="matrix(1.77 0 0 1.82 142.25 263.44)">
          <g vector-effect="non-scaling-stroke">
            <g transform="matrix(1 0 0 1 0 0)">
              <path
                ...
                d="M 50 12.774 C 29.425 12.774 12.773000000000003 29.424999999999997 12.773000000000003 50.001 C 12.773000000000003 70.524 29.424000000000003 87.227 50 87.227 C 70.526 87.227 87.227 70.524 87.227 50.001000000000005 C 87.227 29.425 70.526 12.774 50 12.774 z M 50 83.906 C 31.236 83.906 16.094 68.714 16.094 50.00000000000001 C 16.094 31.236000000000008 31.236 16.09400000000001 50 16.09400000000001 C 68.714 16.09400000000001 83.906 31.236000000000008 83.906 50.00000000000001 C 83.906 68.714 68.714 83.906 50 83.906 z"
            ...
            <g transform="matrix(1 0 0 1 22.13 3.98)">
              <path
                ...
                d="M 80.235 49.295 C 79.982 50.654 78.977 51.005 77.216 50.302 C 76.21 46.981 72.99 46.378 69.66999999999999 45.874 C 71.37799999999999 44.416000000000004 73.99499999999999 43.058 75.35499999999999 46.378 C 77.216 46.931 78.02 45.773 79.88099999999999 46.931 C 80.939 47.032 81.94399999999999 46.980999999999995 83.00099999999999 47.082 C 81.39299999999999 32.443 79.47899999999998 38.328 71.077 35.462 C 67.655 31.186000000000003 66.851 34.204 67.205 41.800000000000004 C 65.142 42.455000000000005 62.477 44.316 65.493 47.886 C 56.940999999999995 54.928000000000004 61.218999999999994 63.282000000000004 72.134 60.915000000000006 L 72.134 74.45 C 78.623 67.757 83.355 60.31100000000001 83.30199999999999 50.604 C 82.901 48.893 81.896 48.441 80.235 49.295 z"
                stroke-linecap="round"
              />
            </g>
            ...
            <g transform="matrix(1 0 0 1 1.76 -24.77)">
              <path
                ...
                d="M 42.103 20.521 C 49.599000000000004 20.671 46.58 32.998000000000005 51.410000000000004 32.845 C 54.379000000000005 28.166999999999998 66.101 27.11 63.231 19.817999999999998 C 56.24 17.401999999999997 48.541000000000004 17.049999999999997 39.99 18.409 C 39.385 19.313 40.693 20.471 42.103 20.521 z"
                stroke-linecap="round"
              />
            </g>
          </g>
